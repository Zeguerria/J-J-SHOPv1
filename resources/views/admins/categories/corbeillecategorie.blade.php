            ...
            <div class="col-md-6 col-md-12 bgnav" style="background-image: url({{asset('glbal/theme/t2.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                ...
                <nav aria-label="breadcrumb" role="navigation" class="d-flex justify-content-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page" style="color:#B460B5;">Corbeille</li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 pt-4 d-flex nav justify-content-end">
                                            <div class="form-group">
                                                ...
                                                <label for=""><a href="./categoriecorbeille" class="btn " data-placement="bottom" id="" data-bs-toggle="tooltip" title="total catégories en corbeille" style="color :#D9B8F7; font-size: 20px;"><i class="fa fa-trash msicons" style="font-size: 20px;"></i></a><sup style="color :#D9B8F7;" >{{$CategorieTotalC}}</sup></label>
                                            </div>
                                            ...
                                            <div class="s">
                                                ...
                                                <div class="modal fade" id="modifier{{$value->id}}">
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            <div class="modal-header bgnav" style="background-image: url({{asset('glbal/theme/t2.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                                <h4 class="modal-title" style="font-size : 35px; font-weight: 900; color :#D9B8F7; "><span><i class="fas fa-retweet"></i></span>&ensp;Restorer la Catégorie : {{$value->nom}}</h4>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: #B460B5;">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            <div class="modal-body" style="background: var(--c-color2);">
                                                                <form method="post" action="{{route('recupCategorie')}}" enctype="multipart/form-data">
                                                                        @csrf
                                                                                        ...
                                                                                        <div class="container-fluid">
                                                                                            <div class="row">
                                                                                                <div class="col-12 col-md-12 col-ml-12 col-lg-12">
                                                                                                    <div class="form-group pt-2">
                                                                                                        <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-file-signature"></i>&ensp;Nom</label>
                                                                                                        <input type="text" value="{{$value->nom}}" readonly class="form-control"  id="nom" name="nom" placeholder="Nom de La Catégorie">
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-12 col-md-12 col-ml-12 col-lg-12">
                                                                                                    <div class="form-group pt-2">
                                                                                                        <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-comment-alt"></i>&ensp;Description</label>
                                                                                                        <input type="text" readonly value="{{$value->description}}" class="form-control"  id="description" name="description" placeholder="Description de La Catégorie">
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                ...
                                <div class="code-box" >
                                    <div class="clearfix p-1">
                                        <div class="container-fluid pt-2">
                                            <div class="row">
                                                    <div class="col" >
                                                        <a href="deleteAllcategorie" data-bs-toggle="tooltip" title="Tout Vider" class="btn btn-sm code-copy pull-left" data-clipboard-target="#basic-table-code"><i class="fa fa-trash" style="font-size: 20px; color:#ff0000;"></i></a>&emsp;
                                                        <a href="recupAllcategorie" data-bs-toggle="tooltip" title="Tout Restorer" data-placement="bottom" class="btn btn-sm code-copy pull-left" data-clipboard-target="#basic-table-code"><i class="fas fa-sync-alt" style="font-size: 20px; color:#3300ff;"></i></a>&emsp;
                                                    </div>
