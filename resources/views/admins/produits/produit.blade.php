        ...
        <div class="content-header pb-5">
            <div class="col-md-6 col-md-12 bgnav" style="background-image: url({{asset('glbal/theme/t2.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                <div class="title pt-2">
                    <h4 class="mb-0 bread"  style="color:#D9B8F7;"><img src="{{asset('glbal/icon/presentation.gif')}}" alt="" class="img img-circle" width="50" height="50">&ensp;Produits</h4>
                </div>
                <nav aria-label="breadcrumb" role="navigation" class="d-flex justify-content-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"  style="color:#B460B5; ">Produits</li>
                                                ...
                                                <div class="modal-dialog  modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header bgnav" style="background-image: url({{asset('glbal/theme/t2.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                            <h4 class="modal-title fw-bold" style="font-size : 35px; font-weight: 900; color :#D9B8F7; "><span><i class="fas fa-cube"></i></span>&ensp;Ajouter un Produit</h4>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-12 col-md-6 col-ml-6 col-lg-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="number" class="form-control" id="quantite" min="0" name="quantite" placeholder="saisir la quantite en stock">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12 col-md-6 col-ml-6 col-lg-6">
                                                                                <div class="form-group">
                                                                                    <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-money-bill-wave-alt"></i>&ensp;Prix</label>
                                                                                    <input type="number" class="form-control" id="prix" min="0" name="prix" placeholder="saisir le prix">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12 col-md-6 col-ml-6 col-lg-6">
                                                                                <div class="form-group">
                                                                                    <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="far fa-money-bill-alt"></i>&ensp;Solde</label>
                                                                                    <input type="number" class="form-control" id="solde" min="0" name="solde" placeholder="saisir le solde">
                                                                                </div>
                                                                            </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select class="form-control select2 text-start" name="categorie_id" style="width: 100%;">
                                                                                        @foreach ($categories as $key => $value)
                                                                                          <option class="text-start" value="{{$value->id}}">{{$value->nom}}</option>
                                                                                          @endforeach
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-12 col-md-4 col-ml-4 col-lg-4">
                                                                                <div class="form-group">
                                                                                    <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-star"></i>&ensp;Qualité du Produit</label>
                                                                                    <select class="form-control select2 text-start" name="parametre_id" style="width: 100%;">
                                                                            ...
                                                                            <div class="col-12 col-md-4 col-ml-4 col-lg-4">
                                                                                <label><i class="fas fa-camera-retro msicons"></i>&ensp;Image Principale</label>
                                                                                <div class="form-group">
                                                                                    <div class="custom-file">
                                                                                      <input type="file" class="custom-file-input" name="photo1" id="customFile" accept=".png,.gpg,.gpeg, .jpg,.avif">
                                                                            ...
                                                                            <div class="col-12 col-md-4 col-ml-4 col-lg-4">
                                                                                <div class="form-group">
                                                                                    <label><i class="fas fa-camera-retro msicons"></i>&ensp;Image Secondaire</label>
                                                                                    <div class="form-group">
                                                                                        <div class="custom-file">
                                                                                        <input type="file" class="custom-file-input" name="photo2" id="customFile" accept=".png,.gpg,.gpeg, .jpg,.avif">
                                                                                        <label class="custom-file-label" for="customFile" style=" color: var(--color-t); font-family: italic;"> <i class="fas fa-image"></i>&ensp;</label>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                            ...
                            <div class="card-body">
                              <table id="example1" class="table table-bordered table-striped text-center">
                                ...
                                <tr class="text-center">
                                    ...
                                    <th> solde </th>
                                    {{-- <th> Boutique </th> --}}
                                    <th> Pas Favori/Favori </th>
                                    <th> Pas Affiche/Affiche </th>
                                    <th> Qualité </th>
                                    <th>Actions</th>
                                </tr>
                                </thead>
                                <tbody >
                                    @foreach($produits as $key => $value)
                                        <tr>
                                            ...
                                            @if($value->favori==0)
                                                <td>
                                                    <a href="{{url('mettrefavori', $value->id)}}" class="btn btn-outline-success" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Mettre en favori" style="font-size: 20px; color:#050034;">Favori</a>
                                                </td>

                                             @else
                                                <td>
                                                    <a href="{{url('retirerfavori', $value->id)}}" class="btn btn-outline-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Retirer des favoris" style="font-size: 20px; color:#050034;" >Normal</a>
                                                </td>
                                             {{-- php artisan serve --}}
                                            @endif
                                            @if($value->vue==0)
                                             ...
                                             @else
                                                <td>
                                                    <a href="{{url('retireraffiche', $value->id)}}" class="btn btn-outline-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Retirer de l'affiche" style="font-size: 20px; color:#050034;" >Normal</a>
                                                </td>
                                             {{-- php artisan serve --}}
                                            @endif
                                            ...
                                            <div class="s">
                                                ...
                                                <div class="modal fade" id="modifier{{$value->id}}">
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            <div class="modal-header bgnav" style="background-image: url({{asset('glbal/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                                <h4 class="modal-title fw-bold" style="font-size : 35px; font-weight: 900; color :#D9B8F7; "><span><i class="fas  fa-pencil-ruler"></i></span>&ensp;Modifier le Produit : {{$value->nom}} {{$value->prenom}}</h4>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: #B460B5;">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                                                ...
                                                                                <div class="col-12 col-md-6 col-ml-6 col-lg-6">
                                                                                    <div class="container-fluid">
                                                                                        <div class=" col-md-12 col-ml-12 col-lg-12">
                                                                                            <div class="form-group pt-2">
                                                                                                <label style=" color: var(--color-t); font-family: italic;"><i class="fas fa-signature msicons"></i>&ensp;Nom </label>
                                                                                                <input type="text" value="{{$value->nom}}" class="form-control" id="description" name="nom" placeholder="Nom de La Catégorie">
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-12 col-md-12 col-ml-12 col-lg-12">
                                                                                            <div class="form-group pt-2">
                                                                                        ...
                                                                                        <div class="col-12 col-md-12 col-ml-12 col-lg-12">
                                                                                            <div class="form-group pt-2">
                                                                                                ...
                                                                                                <input type="text" value="{{$value->prix}}" class="form-control" id="prix" name="prix" placeholder="Prix du produit">
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-12 col-md-12 col-ml-12 col-lg-12">
                                                                                            <img src="{{asset($value->le_profil1)}}" class="img-thumbnail" alt="...">
                                                                                ...
                                                                                <div class=" h-20 col-12 col-md-6 col-ml-6 col-lg-6" >
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-12 col-md-12 col-ml-12 col-lg-12">
                                                                                            <div class="form-group pt-2">
                                                                                                <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-star"></i>&ensp;Qualité du Produit</label>
                                                                                                <select class="form-control select2  d-flex text-start" name="parametre_id" style="width: 100%;">
                                                                                                    @foreach ($parametres as $key => $calit)
                                                                                                      <option class="d-flex text-start" value="{{$calit->id}}" {{($calit->id===$value->parametre_id)?"selected":""}}>{{$calit->libelle}}</option>
                                                                                                      @endforeach
                                                                                                </select>
                                                                                        ...
                                                                                        <div class="col-12 col-md-12 col-ml-12 col-lg-12">
                                                                                            <div class="form-group pt-2">
                                                                                                <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-layer-group"></i>&ensp;Quantité en stock</label>
                                                                                                <input type="text" value="{{$value->quantite}}" class="form-control"  id="quantite" name="quantite" placeholder="Quantité de ce produit">
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-12 col-md-12 col-ml-12 col-lg-12">
                                                                                            <div class="form-group pt-2">
                                                                                                <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-project-diagram"></i>&ensp;Categorie</label>
                                                                                                <select class="form-control select2  d-flex text-start" name="categorie_id" style="width: 100%;">
                                                                                                    @foreach ($categories as $key => $cat)
                                                                                                      <option class="d-flex text-start" value="{{$cat->id}}" {{($cat->id===$value->categorie_id)?"selected":""}}>{{$cat->nom}}</option>
                                                                                                      @endforeach
                                                                                                </select>
                                                                                        ...
                                                                                        <div class="col-12 col-md-12 col-ml-12 col-lg-12">
                                                                                            <div class="form-group pt-2">
                                                                                                <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="far fa-money-bill-alt"></i>&ensp;Solde</label>
                                                                                                <input type="text" value="{{$value->solde}}" class="form-control"  id="solde" name="solde" placeholder="Solde du produit">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                ...
                                <div class="code-box" >
                                    <div class="clearfix p-1">
                                        <div class="container-fluid pt-2">
                                            <div class="row">
                                                    <div class="col" >
                                                        <a href="corbeilleAllproduit" data-bs-toggle="tooltip" title="Tout Supprimer" class="btn btn-sm code-copy pull-left" data-clipboard-target="#basic-table-code"><i class="fa fa-trash" style="font-size: 20px; color:#ff0000;"></i></a>&emsp;
